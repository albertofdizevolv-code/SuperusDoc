...
import 'modal_trecho_ex_widget.dart' show ModalTrechoExWidget;
import 'package:flutter/material.dart';

class ModalTrechoExModel extends FlutterFlowModel<ModalTrechoExWidget> {
  ...
  Future calcularVolumeTotal(BuildContext context) async {
    valorTotal = (valueOrDefault<double>(
            ...
            valueOrDefault<double>(
              functions.replaceCommaToDouble(alturaTextController.text),
              0.0,
            ) *
            valueOrDefault<double>(
