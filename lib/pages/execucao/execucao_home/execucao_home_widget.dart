...
class _ExecucaoHomeWidgetState extends State<ExecucaoHomeWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<VwTabelaHomeRow>>(
      stream: _model.execucaoHomeSupabaseStream ??= SupaFlow.client
          .from("vw_tabela_home")
          .stream(primaryKey: [
            'id_ssa',
            'id_solicitante',
          ...
          .map((list) => list.map((item) => VwTabelaHomeRow(item)).toList()),
                                        ...
                                        if (tableview.isEmpty) {
                                          return Center(
                                            child: ListEmptyWidget(
                                              title: 'Sem OS',
                                              description:
                                                  'No momento não possui nenhuma SSA aguardando a programação',
                                            ),
                                          );
                                        }
