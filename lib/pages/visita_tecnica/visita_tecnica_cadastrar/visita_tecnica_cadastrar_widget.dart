...
import 'visita_tecnica_cadastrar_model.dart';
export 'visita_tecnica_cadastrar_model.dart';

class VisitaTecnicaCadastrarWidget extends StatefulWidget {
  const VisitaTecnicaCadastrarWidget({
    super.key,
  ...
  static String routeName = 'VisitaTecnica_cadastrar';
  static String routePath = '/VisitaTecnica_cadastrar';

  @override
  State<VisitaTecnicaCadastrarWidget> createState() =>
      _VisitaTecnicaCadastrarWidgetState();
}

class _VisitaTecnicaCadastrarWidgetState
    extends State<VisitaTecnicaCadastrarWidget> {
  late VisitaTecnicaCadastrarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VisitaTecnicaCadastrarModel());
