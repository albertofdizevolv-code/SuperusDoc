...
import 'visita_tecnica_home_model.dart';
export 'visita_tecnica_home_model.dart';

class VisitaTecnicaHomeWidget extends StatefulWidget {
  const VisitaTecnicaHomeWidget({super.key});

  static String routeName = 'VisitaTecnica_home';
  static String routePath = '/visitaTecnicaHome';

  @override
  State<VisitaTecnicaHomeWidget> createState() =>
      _VisitaTecnicaHomeWidgetState();
}

class _VisitaTecnicaHomeWidgetState extends State<VisitaTecnicaHomeWidget> {
  late VisitaTecnicaHomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VisitaTecnicaHomeModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<VwTabelaHomeRow>>(
      future: VwTabelaHomeTable().queryRows(
        queryFn: (q) =>
            q.or("status.eq.\"Visita Pendente\", status.eq.\"Aberto\""),
      ),
      builder: (context, snapshot) {
        ...
        List<VwTabelaHomeRow> visitaTecnicaHomeVwTabelaHomeRowList =
            snapshot.data!;

        return Title(
            title: 'VisitaTecnica_home',
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        ...
                                        return FlutterFlowDataTable<
                                          ...
                                          dataRowBuilder: (terItem, terIndex,
