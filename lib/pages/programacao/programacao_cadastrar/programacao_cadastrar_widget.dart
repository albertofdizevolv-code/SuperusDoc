...
import 'programacao_cadastrar_model.dart';
export 'programacao_cadastrar_model.dart';

class ProgramacaoCadastrarWidget extends StatefulWidget {
  const ProgramacaoCadastrarWidget({
    super.key,
  ...
  static String routeName = 'programacao_cadastrar';
  static String routePath = '/programacaoCadastrar';

  @override
  State<ProgramacaoCadastrarWidget> createState() =>
      _ProgramacaoCadastrarWidgetState();
}

class _ProgramacaoCadastrarWidgetState
    extends State<ProgramacaoCadastrarWidget> {
  late ProgramacaoCadastrarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProgramacaoCadastrarModel());
