...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF23593A);
  late Color secondary = const Color(0xFF22372B);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF323743);
  ...
  late Color accent4 = const Color(0xFFBDC1CA);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);

  late Color lightGreen = const Color(0xFF3C614A);
  late Color customColor1 = const Color(0xFF0CD70B);
  late Color lightGray = const Color(0xFFBDC1CA);
  late Color menu = const Color(0xFF003314);
}
